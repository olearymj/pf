...
function makeElements(sensorValue,valueNumber){
  ...
  var src = 'images/lightLeaf.png';
  if(isEven(valueNumber)){
    src = 'images/darkLeaf.png';
  }


  if(makeX(sensorValue)==0){
    $(targetId).after('<img id= "'+imgId+'" src="'+src+'" alt="Leaf" />');
...
body{
background-image:url('images/brown3.jpeg');
}
...
<div id="firstcolumn"><img id= "first" src="images/darkLeaf.png" alt="Leaf"  /></div>
<div id="secondcolumn"><img id= "second" src="images/lightLeaf.png" alt="Leaf" /></div>
</div>
<div id="thirdcolumn"><img id= "third" src="images/darkLeaf.png" alt="Leaf" /></div>
</div>
<div class="leftsideright">
<div id="fourthcolumn"><img id= "fourth" src="images/lightLeaf.png" alt="Leaf" /></div>
<div id="fifthcolumn"><img id= "fifth" src="images/darkLeaf.png" alt="Leaf"  /></div>
</div>
</div>
<div id="rightside">
<div class="leftsideleft">
<div class="leftcolumn">
<div id="sixthcolumn"><img id= "sixth" src="images/lightLeaf.png" alt="Leaf" /></div>
<div id="seventhcolumn"><img id= "seventh" src="images/darkLeaf.png" alt="Leaf"  /></div>
</div>
<div id="eighthcolumn"><img id= "eighth" src="images/lightLeaf.png" alt="Leaf" /></div>
</div>
<div class="leftsideright">
<div id="ninthcolumn"><img id= "ninth" src="images/darkLeaf.png" alt="Leaf"  /></div>
<div id="tenthcolumn"><img id= "tenth" src="images/lightLeaf.png" alt="Leaf" /></div>
</div>
</div>
